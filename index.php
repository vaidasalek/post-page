		...
		<div class="container">
			...
			<div class="row">
				...
				<div class="col-lg-4 mr-auto text-center">
					<i class="fas fa-envelope fa-3x mb-3 text-muted"></i><a class="d-block text-dark" href="mailto:contact@yourwebsite.com">contact@postpage.com</a>
				</div>
			</div>
		</div>
	</section><!-- Footer-->
