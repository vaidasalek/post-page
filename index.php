...
<html lang="en">
    ...
    <body id="page-top">
        ...
        <nav class="navbar navbar-expand-lg navbar-light fixed-top py-3" id="mainNav">
            <div class="container">
                <a class="navbar-brand js-scroll-trigger" href="#page-top">Blog Page</a><button class="navbar-toggler navbar-toggler-right" type="button" data-toggle="collapse" data-target="#navbarResponsive" aria-controls="navbarResponsive" aria-expanded="false" aria-label="Toggle navigation"><span class="navbar-toggler-icon"></span></button>
                <div class="collapse navbar-collapse" id="navbarResponsive">
                    <ul class="navbar-nav ml-auto my-2 my-lg-0">
                        <li class="nav-item"><a class="nav-link js-scroll-trigger" href="#post">Posts</a></li>
            ...
            <div class="container h-100">
                <div class="row h-100 align-items-center justify-content-center text-center">
                    ...
                    <div class="col-lg-8 align-self-baseline">
                        <p class="text-white-75 font-weight-light mb-5">Hey i hope you will like reading my ideas and stories. Enjoy!</p>
                        <a class="btn btn-xl js-scroll-trigger" href="#post">Blogspot</a>
                    </div>
                </div>
            </div>
        </header>
        ...
        <section class="page-section" id="post">
            <div class="container">
                <h2 class="text-center mt-0">Posts</h2>
                <hr class="divider my-4" />
                <div class="row">
						  <div class="span8">
							 <div class="row">
							 ...
							 <div class="row">
								<div class="span6">
								 ...
								 <a href="assets/pages/postpage1.php"><button type="button" class="btn btn-sm custom-btn">Read more</button></a>
								</div>
							 </div>
							 <div class="row">
								<div class="span8">
